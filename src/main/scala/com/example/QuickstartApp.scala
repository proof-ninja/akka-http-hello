...
object QuickstartApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rootBehavior = Behaviors.setup[Nothing] { context =>
      ...
      val helloRoute = new HelloRoutes().helloRoute
      val userRoutes = new UserRoutes(userRegistryActor)(context.system).userRoutes
      ...
      startHttpServer(topLevelRoute)(context.system)
